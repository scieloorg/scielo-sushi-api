...
DB_CALL_TR_J3_TOTALS = 'CALL TR_J3_TOTALS("%s", "%s", "%s")'
DB_CALL_TR_J3_MONTHLY = 'CALL TR_J3_MONTHLY("%s", "%s", "%s")'
DB_CALL_TR_J3_JOURNAL_TOTALS = 'CALL TR_J3_JOURNAL_TOTALS("%s", "%s", "%s", "%s")'
DB_CALL_TR_J3_JOURNAL_MONTHLY = 'CALL TR_J3_JOURNAL_MONTHLY("%s", "%s", "%s", "%s")'
